...
$routes->group('app', ['filter' => 'auth'], function($routes) {
    ...
    $routes->get('transaction', 'App\Transaction::index'); // Route for listing transactions
    ...
    $routes->get('transaction/processGrowth/(:num)/(:any)/(:any)/(:num)', 'TransactionController::processGrowth/$1/$2/$3/$4');
